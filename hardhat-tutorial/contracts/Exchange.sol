...
contract Exchange is ERC20 {
    ...
    /**
     * @dev Returns the amount of `Crypto Dev Tokens` held by the contract. The ETH reserve would 
     * be equal to the balance of the contract and can be found using address(this).balance
     */
